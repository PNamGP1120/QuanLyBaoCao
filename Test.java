...
//        System.out.print( baoCaoKhoaLuan.tinhTrungBinh());
        BaoCao baoCao=new BaoCaoDoAn("Đồ án 1","D:\\DoAn", LocalDate.parse("12/12/2024", DateTimeFormatter.ofPattern(CauHinh.DATE_FORMATTER)),new GiangVien("GV1-GiangVien1-HH1-HV1".split("-")));
        baoCao.chamDiem();
    }
}
